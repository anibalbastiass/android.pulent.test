...
import com.anibalbastias.android.pulentapp.presentation.BaseDataManager
 ...
 */
class ResultItemViewModelTest  : BaseUnitTest() {
    ...
    override fun initViewModel() {
        resultItemViewModel = ResultItemViewModel(
    ...
    fun testSearchAlbumsResultsUseCase() {
        resultItemViewModel.getSearchSongsResultsData()
    ...
    fun testStatusLiveDataTestDriveCompleteItem_isLoading() {
        resultItemViewModel.let { viewModel ->
            resultItemViewModel.getSearchSongsResultsData()
    ...
    fun testStatusLiveDataTestDriveCompleteItem_isError() {
        ...
        resultItemViewModel.let { viewModel ->
            ...
            captorSearchMusic.let {
                ...
                it.firstValue.onError(
                    BaseDataManager.getErrorMessage(
                        showErrorMessage(),
                        methodName
                    )
                )
