package com.anibalbastias.android.pulentapp.presentation.util.adapter.base
 ...
 */
abstract class BaseBindRecyclerAdapter<T>(val clickHandler: BaseBindClickHandler<T>? = null) : RecyclerView.Adapter<BaseBindViewHolder<T>>(),
